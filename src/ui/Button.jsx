...
function Button({ children, disabled, to, type }) {
  ...
  focus:ring-offset-2 disabled:cursor-not-allowed cursor-pointer`;
  ...
  const styles = {
    ...
    focus:text-stone-800 focus:bg-stone-300 focus:outline-none focus:ring focus:ring-stone-200 
    focus:ring-offset-2 disabled:cursor-not-allowed px-4 py-2.5 md:px-6 md:py-3.5 cursor-pointer`,
  };
